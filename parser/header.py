class Header:
    def __init__(self, trans_id: int, flags: int, questions_count: int,
                 answers_count: int, auth_count: int, additional_count: int):
    ...
    def __str__(self):
        return (f'ID: {self.trans_id}, Queries: {self.queries_count}, '
